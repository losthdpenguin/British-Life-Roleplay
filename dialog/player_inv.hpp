...
class playerSettings {
    ...
    class controls {
        ...
        class ButtonMyBuisness: Life_RscButtonMenu {
            idc = 2011;
            text = "Buisness";
        ...
        class Governement: Life_RscButtonMenu {
            idc = -1;
            text = "Government";
        ...
        class ButtonPlate: Life_RscButtonMenu {
            idc = 3456;
            text = "Plate";
            onButtonClick  = "createDialog ""max_search_plate""";
        ...
        class ButtonPoints: Life_RscButtonMenu {
            idc = 7685;
            text = "Points";
            onButtonClick  = "createDialog ""Cop_points_search""";
