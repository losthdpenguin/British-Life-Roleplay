...
private _currdamage = damage player;
...
if (vehicle _unit == _unit) then {
    if (_source isKindOf "Air" OR _source isKindOf "Car" OR _source isKindOf "Ship" OR _source isKindOf "Tank") then {
    } else {
        _isVehicle = vehicle _source;
        if (_isVehicle isKindOf "Air" OR _isVehicle isKindOf "Car" OR _isVehicle isKindOf "Ship" OR _isVehicle isKindOf "Tank") then
        {
            _damage = _currdamage;
        };
    };
