...
[[0,1],"STR_GNOTF_CaptureSuccess",true,[(format ["%1 %2",identity_prenom,identity_nom]),(group player) getVariable "gang_name"]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
