...
if (_adresse != "No Information") then {ctrlSetText [5104,_adresse];};
if (_ville != "No Information") then {ctrlSetText [5105,_ville];};
if (_numero != "No Information") then {ctrlSetText [5106,_numero];};
if (_autre != "No Information") then {ctrlSetText [5108,_autre];};
