...
if ([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_gouverneur) then {
    _display = findDisplay 1600;
} else {
    if ([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_ministres) then {
