...
if ((!([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_ministres)) && (!([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_security))) exitWith {};
...
_message = format [(["STR_GOVERNEMENT_LEAVE_GLOBAL"] call max_gouvernement_fnc_localize),((format ["%1 %2",identity_prenom,identity_nom]))];
