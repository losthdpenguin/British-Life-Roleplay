...
[maxence_compte_gouv,maxence_compte_cop,maxence_compte_med,((format ["%1 %2",identity_prenom,identity_nom])),3,0,_taxe,_mode] remoteExec ["max_gouvernement_fnc_updateAccounts",2];
