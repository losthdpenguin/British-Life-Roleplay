/*
    ...
    Owner's name:
*/
if ((!([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_gouverneur)) && (!([((format ["%1 %2",identity_prenom,identity_nom])),(getPlayerUID player)] in maxence_ministres))) exitWith {};
...
switch (_from) do { 
    case 0 : {
        ...
        switch (_to) do { 
            ...
            case 3 : {
                _toTXT = (format ["%1 %2",identity_prenom,identity_nom]);
    ...
    case 3 : {
        _fromTXT = (format ["%1 %2",identity_prenom,identity_nom]);
        if (life_atmbank < _value) exitWith {_exit = true;};
        life_atmbank = life_atmbank - _value;
        [1] call SOCK_fnc_updatePartial;
        switch (_to) do { 
            case 0 : {
...
[maxence_compte_gouv,maxence_compte_cop,maxence_compte_med,((format ["%1 %2",identity_prenom,identity_nom])),_from,_to,_value,0] remoteExec ["max_gouvernement_fnc_updateAccounts",2];
