...
[maxence_compte_gouv,maxence_compte_cop,maxence_compte_med,((format ["%1 %2",identity_prenom,identity_nom])),_type,3,_value,0] remoteExec ["max_gouvernement_fnc_updateAccounts",2];
