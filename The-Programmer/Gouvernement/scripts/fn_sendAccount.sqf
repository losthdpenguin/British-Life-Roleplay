...
if (life_atmbank < _value) exitWith {hint (["STR_NOT_ENOUGHT_MONEY"] call max_gouvernement_fnc_localize);};
...
[maxence_compte_gouv,maxence_compte_cop,maxence_compte_med,((format ["%1 %2",identity_prenom,identity_nom])),3,_type,_value,0] remoteExec ["max_gouvernement_fnc_updateAccounts",2];
