    ...
    case 1 : {
...

        {
            if ((getPlayerUID _x) isEqualTo (_unit select 1)) exitWith {
                [1,format [(["STR_BE_KICKED_GOUVERNEMENT_SUCCES"] call max_gouvernement_fnc_localize),(format ["%1 %2",identity_prenom,identity_nom])]] remoteExecCall ["life_fnc_broadcast",_x];
            };
