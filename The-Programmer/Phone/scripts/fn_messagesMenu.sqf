...
(_display displayCtrl 98150) ctrlSetText (["STR_MSG_TEXT"] call max_phone_fnc_localize);
(_display displayCtrl 98151) ctrlSetText (["STR_FROM"] call max_phone_fnc_localize);
(_display displayCtrl 98152) ctrlSetText (["STR_MSG_TEXT"] call max_phone_fnc_localize);
(_display displayCtrl 98114) ctrlSetText (["STR_DELETE_BUTTON"] call max_phone_fnc_localize);
(_display displayCtrl 98115) ctrlSetText (["STR_REPLY"] call max_phone_fnc_localize);
