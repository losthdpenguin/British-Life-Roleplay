...
*/
    ...
    player createDiaryRecord ["credits",
        [
            "British Life Roleplay",
                "
British Life Roleplay (formerly ArmaLife) Is using Tonics 5.0 Framework with Custom Modules.<br/><br/>
                "
        ]
    ];
...
Government Complex<br/><br/>
Kavala Town Square<br/><br/>
20 Meteres of any ATM<br/><br/>
...
// Police Section
    player createDiaryRecord ["policerules",
        [
            "Crisis Negotiation",
                "
Crisis Negotiation must be handled by designated officers which can be found in the Royal Altis Police Handbook. If one is not available, the person with the next highest rank must handle the situation.<br/><br/>
                "
        ]
    ];
    ...
    player createDiaryRecord ["policerules",
        [
            "The HM Treasury",
                "
1. The HM Treasury is illegal for civilians to enter, unless they have been given authorization. If civilians enter without authorization they are to be escorted off-site or arrested if they persist.
2. Helicopters flying over the HM Treasury may be asked to leave and disabled if they refuse.<br/>
3. If the HM Treasury is getting robbed, it is encouraged that all available officers move in to stop it.<br/>
4. Nearby officers should immediately head to the HM Treasury to assist. Petty crimes can be dropped during a robbery.<br/>
...
4. Patrols should ideally be with 2 officers to a vehicle.
                "
        ]
    ];
...
2. Vehicles that look abandoned, broken, with no driver, can be ticketed or impounded.<br/>
...
Highways (Orange): 30km/h<br/>
Countryside Roads (White): 30km/h<br/>
Dirt Roads (Beige): 30km/h<br/>
Outside major cities:<br/>
Highways (Orange): 130km/h<br/>
Countryside Roads (White): 100km/h<br/>
Dirt Roads (Beige): 70km/h<br/><br/>
                "
        ]
    ];
