    ...
    */
    ...
    class C_Offroad_01_F {
        ...
        textures[] = {
            ...
            { "Police", "cop", {
                "textures\RA-policeoffroader.paa"
            }, "" }
        };
    };
...
*/
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
            ...
            { "Police Gray", "cop", {
                "textures\RAPoliceGray.paa"
            }, "" },
            { "Police White", "cop", {
                "textures\RAPoliceWhite.paa"
            }, "" },
            { "Blue Armed Response Marked", "cop", {
                "textures\RAPoliceDarkBlue.paa"
            }, "" },
            { "Dark Blue Armed Response Marked", "cop", {
                "textures\RAPoliceBlue.paa"
            }, "" },
            { "Medic", "med", {
                "textures\paramedic_suv.jpg"
            }, "" }
        };
    };
...
//end custom
	...
	class B_GEN_Van_02_transport_F {
        ...
        price = 10000;
        textures[] = {
            { "Police Transport Van", "cop", {
                "textures\police_transport_van.paa",
				"textures\van_wheel_CO.paa",
				"textures\police_transport_van_glass.paa"
            }, "" },
			{ "Police Prisoner Transport Van", "cop", {
                "textures\prisoner_van.paa",
				"textures\van_wheel_CO.paa",
				"textures\prisoner_van_windows.paa"
            }, "" }
        };
    };
	class C_Van_02_medevac_F {
        ...
        price = 10000;
        textures[] = {
            { "Ambulance Transit", "med", {
                "textures\ambulance_transport.paa",
				"textures\van_wheel_CO.paa",
				"textures\ambulance_transport_glass.paa"
            }, "" }
        };
	};
};
