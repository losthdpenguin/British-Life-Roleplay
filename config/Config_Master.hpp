...
/* System Settings */
    /* ATM & HM Treasury System Configurations */
    ...
    minimum_cops = 5; //Minimum cops required online to rob the HM Treasury
    ...
    respawn_timer = 0; //need to change back to 120 //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    restricted_uniforms[] = { "U_Rangemaster", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform", "U_B_GEN_Commander_F" };
    ...
    paycheck_med = 2200; //Payment for medics
    ...
    seize_uniform[] = { "U_Rangemaster", "U_B_GEN_Commander_F" }; //Any specific uniforms you want to be seized from players
